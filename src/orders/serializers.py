...
class ScheduledReparkSerializer(serializers.ModelSerializer):
	...
	class  Meta:
		...
		fields = ('id','request_uuid', 'requested_by','reparked_by','pickup_location','dropoff_location','requested_at','picked_up_at','dropped_off_at', 'is_active', 'in_progress','is_completed','valet_start_pos', 'scheduled_start_date','scheduled_end_date','time_limit','parking_exp_time')
		depth = 1